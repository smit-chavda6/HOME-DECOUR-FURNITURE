...
(function () {
    ...
    function renderProducts() {
        ...
        products.forEach(p => {
            ...
            const flags = [];
            if (p.is_featured) flags.push('<span class="ap-badge featured"><svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg> Featured</span>');
            if (p.is_trending) flags.push('<span class="ap-badge trending"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19c-1.5 0-3-1.5-3-4C14.5 9 12 6 12 6s-2 3-2 6c0 4 2 6 2 6"></path><path d="M12 22A8.5 8.5 0 0 1 3.5 13.5C3.5 11 9 4 12 2c3 2 8.5 9 8.5 11.5A8.5 8.5 0 0 1 12 22Z"></path></svg> Trending</span>');
            if (p.is_new_arrival) flags.push('<span class="ap-badge new"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg> New</span>');
            ...
            tr.innerHTML = `
                ...
                <td>
                    <div class="ap-actions-cell" style="display:flex; gap:6px; align-items:center;">
                        <button class="ap-btn sm" title="Edit" data-edit="${p.id}" style="padding:6px; display:inline-flex; align-items:center; justify-content:center;">
                        ...
                        <button class="ap-btn sm danger" title="Delete" data-delete="${p.id}" data-name="${escHtml(p.name)}" style="padding:6px; display:inline-flex; align-items:center; justify-content:center;">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                        </button>
                        <a class="ap-btn sm" href="product-details.html?id=${p.id}" target="_blank" title="View" style="padding:6px; display:inline-flex; align-items:center; justify-content:center;">
